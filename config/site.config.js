...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'zbn@bnnk.cc',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/king-zhangbn/',
    },
  ],
